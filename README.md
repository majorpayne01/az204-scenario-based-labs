...
- Must upgrade the starter and solution project to **.NET 8** from **.NET 3**, which is no longer supported. This also includes upgrading the Newtonsoft.Json to 13.0.3 and making sure the **Microsoft.NET.SDK.Functions** version in your .csproj file of each solution is **4.2.0** or later.
