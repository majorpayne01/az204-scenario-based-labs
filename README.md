...
- For the function and web app deployments I preferred publishing the web app locally, zipping it, then deploying it to azure so I didn't follow the instructions for those tasks. 
